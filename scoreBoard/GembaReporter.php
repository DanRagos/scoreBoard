...
<head>
    ...
    <link rel="stylesheet" href="assets/css/DataTablesNew/datatables.min.css">
    ...
    <link rel="stylesheet" href="assets/css/DataTablesNew/Buttons-2.4.1/css/buttons.bootstrap5.min.css">
    <link rel="stylesheet" href="assets/css/DataTablesNew/Buttons-2.4.1/css/buttons.dataTables.min.css">
    <link rel="stylesheet" href="assets/css/DataTablesNew/Buttons-2.4.1/css/buttons.jqueryui.min.css">
    <link rel="stylesheet" href="assets/css/DataTablesNew/Buttons-2.4.1/css/common.scss">
    <link rel="stylesheet" href="assets/css/DataTablesNew/Buttons-2.4.1/css/mixins.scss">
    <link rel="stylesheet" href="assets/css/DataTablesNew/FixedHeader-3.4.0/css/fixedHeader.bootstrap5.min.css">
    <link rel="stylesheet" href="assets/css/DataTablesNew/FixedHeader-3.4.0/css/fixedHeader.dataTables.min.css">
    <link rel="stylesheet" href="assets/css/DataTablesNew/FixedHeader-3.4.0/css/fixedHeader.jqueryui.min.css">
    <link rel="stylesheet" href="assets/css/DataTablesNew/Responsive-2.5.0/css/responsive.bootstrap5.min.css">
    <link rel="stylesheet" href="assets/css/DataTablesNew/Responsive-2.5.0/css/responsive.dataTables.min.css">
    <link rel="stylesheet" href="assets/css/DataTablesNew/Responsive-2.5.0/css/responsive.jqueryui.min.css">
    <link rel="stylesheet" href="assets/css/DataTablesNew/RowGroup-1.4.0/css/rowGroup.bootstrap5.min.css">
    <link rel="stylesheet" href="assets/css/DataTablesNew/RowGroup-1.4.0/css/rowGroup.dataTables.min.css">
    <link rel="stylesheet" href="assets/css/DataTablesNew/RowGroup-1.4.0/css/rowGroup.jqueryui.min.css">
    <link rel="stylesheet" href="assets/css/DataTablesNew/Select-1.7.0/css/select.bootstrap5.min.css">
    <link rel="stylesheet" href="assets/css/DataTablesNew/Select-1.7.0/css/select.dataTables.min.css">
    <link rel="stylesheet" href="assets/css/DataTablesNew/Select-1.7.0/css/select.jqueryui.min.css">
    <link rel="stylesheet" href="assets/css/card-custom.css?version=1">
    <link rel="stylesheet" href="assets/css/DataTablesNew/DataTables-1.13.5/css/dataTables.bootstrap5.min.css">
    <link rel="stylesheet" href="assets/css/DataTablesNew/DataTables-1.13.5/css/jquery.dataTables.min.css">
    <link rel="stylesheet" href="assets/css/jquery-ui.min.css">
    <link rel="stylesheet" href="assets/css/jquery-ui-timepicker-addon.css">
    <link rel="stylesheet" href="assets/css/animate.css">
    <link rel="stylesheet" href="assets/css/bootstrap-select.min.css">
    <!-- <link rel="stylesheet" href="assets/css/bootstrap-select.min.css"> -->
    <!-- <link rel="stylesheet" href="assets/css/Custom/dashboardDesktop.css?version=5?<?=__DEBUG__?time():''?>" rel="stylesheet"> -->
    <link rel="stylesheet" href="assets/css/Custom/dashboardDesktop.css?version=5<?= isset($_DEBUG) ? '&' . time() : '' ?>" rel="stylesheet">
...
<body class="flex-grow-1 dark-bg" style="width: 100%;height: 100%;">
    <div id="page-header" style="background-color: #444f51;">
        ...
        <button
            class="btn btn-primary btn-sm shadow-none float-end my-2 me-2" id="logout-btn" type="button" style="background-color: rgb(68,79,81);"><i class="fa fa-sign-out text-danger"></i><label style="margin-bottom: 0;" for="logout-btn">&nbsp;<span>Logout</span></label>
        </button>
        <button class="btn btn-primary btn-sm shadow-none float-end my-2" id="pref-btn" type="button" style="background-color: rgb(68,79,81);margin-right: 0px;margin-left: 0px;"><i class="fa fa-cog"></i><label style="margin-bottom: 0;" for="pref-btn">&nbsp;<span>Preferences</span></label></button>
    </div>
    <!-- height: 100vh -->
    <div id="sidebar" style="position: fixed; background-color: rgba(74,80,89,0.98);height: 100%; overflow: hidden;color: rgb(33,37,41);">
        <div id="sidebar-header" style="background-color: rgba(48,56,58,0.75);padding-right: 7px;padding-left: 15px;opacity: 1;">
            ...
            <button class="btn btn-primary btn-sm border rounded-circle float-end m-2" id="close-sidebar" type="button" style="background-color: rgba(0,123,255,0.6);">
        ...
        <div class="tablist-container">
            <ul role="tablist">
                <!-- Start: control -->
                <li>
                    <button id="control-tab-btn" class="btn btn-primary btn-tab" type="button" style="color: #f8f9fa;" data-bs-toggle="tab" data-bs-target="#control-tab" role="tab">
                        <i class="fa fa-toggle-on"></i>&nbsp;<span id="tabControltitle">Control</span>
                    </button>
                </li>
                <li>
                    <button id="schedule-tab-btn" class="btn btn-primary btn-tab" type="button" role="tab" data-bs-toggle="tab" data-bs-target="#schedule-tab"><i class="fa fa-calendar"></i>&nbsp; 
                ...
                <!-- Start: display -->
                <li>
                    <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#display-option" aria-expanded="false"><i class="fa fa-tv"></i>&nbsp;<span id="tabDisplaytitle">Display</span><i class="fa fa-caret-down float-end"></i></button>
                    <div id="display-option"
                        class="collapse">
                        <ul>
                            <li><button class="btn btn-primary btn-tab" type="button" role="tab" data-bs-toggle="tab" data-bs-target="#dashboard-tab"><i class="fa fa-tachometer"></i>&nbsp;<span id="tabDashboardtitle">Count Dashboard</span></button></li>
                            <li><button class="btn btn-primary btn-tab" type="button" role="tab" data-bs-toggle="tab" data-bs-target="#duration-tab"><i class="fa fa-clock-o"></i>&nbsp;<span id="tabDurationtitle">Duration Dashboard</span></button></li>
                            <li><button class="btn btn-primary btn-tab" type="button" role="tab" data-bs-toggle="tab" data-bs-target="#overview-tab"><i class="fa fa-th"></i>&nbsp;<span id="tabOverviewtitle">Overview</span></button></li>
                        </ul>
                    </div>
                </li>
                <!-- End: display -->
                <!-- Start: records -->
                <li><button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#record-options" aria-expanded="false"><i class="fa fa-list-alt"></i>&nbsp;<span id="tabRecordtitle">Records</span><i class="fa fa-caret-down float-end"></i></button>
                    <div id="record-options"
                        class="collapse">
                        <ul>
                            <li><button id="summary-tab-btn" class="btn btn-primary btn-tab" type="button" role="tab" data-bs-toggle="tab" data-bs-target="#summary-tab"><i class="fa fa-bar-chart"></i>&nbsp;<span id="tabSummarytitle">Summary</span></button></li>
                            <li><button id="reject-tab-btn" class="btn btn-primary btn-tab" type="button" role="tab" data-bs-toggle="tab" data-bs-target="#reject-tab"><i class="fa fa-trash-o"></i>&nbsp; <span id="tabRejecttitle">Rejects</span></button></li>
                            <li><button id="visual-tab-btn" class="btn btn-primary btn-tab" type="button" role="tab" data-bs-toggle="tab" data-bs-target="#visual-tab"><i class="fa fa-chart-area"></i>&nbsp;<span id="tabVisualizationtitle">Productivity</span></button></li>
                            <li><button id="detail-tab-btn" class="btn btn-primary btn-tab" type="button" role="tab" data-bs-toggle="tab" data-bs-target="#detail-tab"><i class="fas fa-list-ul"></i>&nbsp; <span id="tabDetailTitle">JO Time Chart</span></button></li>
                            <li hidden><button class="btn btn-primary btn-tab" type="button" role="tab" data-bs-toggle="tab" data-bs-target="#unproductive-tab"><i class="fa fa-level-down"></i>&nbsp; &nbsp;<span id="tabUnprodtitle">Unproductive</span></button></li>
                            <!-- <li><button id="schedule-tab-btn" class="btn btn-primary btn-tab" type="button" role="tab" data-bs-toggle="tab" data-bs-target="#schedule-tab"><i class="fa fa-calendar"></i>&nbsp; <span id="tabSchedtitle">Schedule</span></button></li> -->
                        </ul>
                    </div>
                </li>
                <!-- End: records -->
                <!-- Start: Settings -->
                <li><button class="btn btn-primary" id="sidepanel-config-btn" type="button" data-bs-target="#settings-option" data-bs-toggle="collapse" aria-expanded="false"><i class="fa fa-cogs"></i>&nbsp;<span id="tabConfigtitle">Configuration</span><i class="fa fa-caret-down float-end"></i></button>
                    <div
                        id="settings-option" class="collapse">
                        <ul>
                            <li><button id="cluster-tab-btn" class="btn btn-primary btn-tab" type="button" data-bs-target="#cluster-tab" data-bs-toggle="tab" role="tab"><i class="fa fa-cubes"></i>&nbsp;<span id="tabClustertitle">Clusters</span></button></li>
                            <li><button id="system-tab-btn" class="btn btn-primary btn-tab" type="button" data-bs-target="#date-tab" data-bs-toggle="tab" role="tab"><i class="fa fa-wrench"></i>&nbsp; <span id="tabSystemtitle">System</span></button></li>
                            <!-- <li><button id="swupdate-tab-btn" class="btn btn-primary btn-tab" type="button" data-bs-target="#update-tab" data-bs-toggle="tab" role="tab"><i class="icon ion-ios-reload"></i>&nbsp; <span id="tabUpdatetitle">Software Update</span></button></li> -->
                        </ul>
        </div>
        </li>
        <!-- End: Settings -->
        <!-- Start: about -->
        <li><button class="btn btn-primary btn-tab" type="button" role="tab" data-bs-target="#about-tab" data-bs-toggle="tab"><i class="fa fa-question-circle-o"></i>&nbsp;<span id="tabAbouttitle">About</span></button></li>
        <!-- End: about -->
        </ul>
        </div>
        ...
        <div id="page-content" class="tab-content">
            <!-- CONTROL-TAB inside the pages folder -->
            <?php include 'pages/control-tab.php'; ?>
            <div id="dashboard-tab" class="tab-pane fade" role="tabpanel">
                <div class="page-subheader">
                    <div>
                        <div class="last-update" style="margin-right: 25px;">
                            <label class="text-truncate" style="margin-bottom: 0px;">Last Update: yyyy-mm-dd hh:mm:ss</label>
                        </div>
                        <span class="headerspan">
                            <span id="pgeDashboardtitle" class="pl-3" style="background-color: rgba(196,204,204,0);">Count Dashboard</span>
                            <span class="groupName"></span>
                        </span>
                        <div class="dash-paging">
                            <button class="btn btn-sm shadow-none dash-page-left" type="button" style="display: none">
                                <i class="fa fa-caret-left" style="color: #565959;"></i>
                            </button>
                            <label>Page 1 of 1</label>
                            <button class="btn btn-sm shadow-none dash-page-right" type="button" style="display: none">
                                <i class="fa fa-caret-right" style="color: #565959;"></i>
                            </button>
                        </div>
                    </div>
                </div>
                <div id="dashboard-container" style="position: fixed; height: calc(100% - 78px);">
                    <!-- Start: page-left -->
                    <div class="dash-page-btn dash-page-left text-center" type="button"><i class="fa fa-chevron-left text-light fa-3x"></i></div>
                    <!-- End: page-left -->
                    <!-- Start: page-right -->
                    <div class="dash-page-btn dash-page-right text-center" type="button"><i class="fa fa-chevron-right text-light fa-3x"></i></div>
                    <!-- End: page-right -->
                    <!-- Start: dashboard-pane -->
                    <div class="dashboard-pane">
                        <!-- Start: dashboard-pane-frame -->
                        <div class="dashboard-pane-frame">
                            <!-- Start: dashboard-pane-subframe -->
                            <div class="dashboard-pane-subframe">
                                <div><span>Machine ID</span></div>
                                <div class="text-truncate"><span>--</span></div>
                            </div>
                            <!-- End: dashboard-pane-subframe -->
                            <!-- Start: dashboard-pane-subframe -->
                            <div class="dashboard-pane-subframe">
                                <div><span>Machine Status</span></div>
                                <div class="text-truncate"><span>--</span></div>
                            </div>
                            <!-- End: dashboard-pane-subframe -->
                            <!-- Start: dashboard-pane-subframe -->
                            <div class="dashboard-pane-subframe">
                                <div><span>Prewarn</span></div>
                                <div class="text-truncate"><span>--</span></div>
                            </div>
                            <!-- End: dashboard-pane-subframe -->
                            <!-- Start: dashboard-pane-subframe -->
                            <div class="dashboard-pane-subframe">
                                ...
                                <div><div class="progress">
                                    ...
                                    <div class="progress-bar-title">100%</div>
                                </div></div>
                            </div>
                            <!-- End: dashboard-pane-subframe -->
                        </div>
                        <!-- End: dashboard-pane-frame -->
                    </div>
                    <!-- End: dashboard-pane -->
                    <!-- Start: dashboard-pane -->
                    <div class="dashboard-pane">
            ...
            <div id="duration-tab" class="tab-pane fade" role="tabpanel">
                <div class="page-subheader">
                    <div>
                        <div class="last-update" style="margin-right: 25px;">
                            <label class="text-truncate" style="margin-bottom: 0px;">Last Update: yyyy-mm-dd hh:mm:ss</label>
                        ...
                        <span class="headerspan">
                            <span id="pgeDurationtitle" class="pl-3" style="background-color: rgba(196,204,204,0);">Duration Dashboard</span>
                            <span class="groupName"></span>
                        </span>
                        <div class="dash-paging">
                            <button class="btn btn-sm shadow-none dash-page-left" type="button" style="display: none">
                ...
                <div id="duration-container" style="position: fixed; height: calc(100% - 78px);">
                    <!-- Start: page-left -->
                    <div class="dash-page-btn dash-page-left text-center" type="button"><i class="fa fa-chevron-left text-light fa-3x"></i></div>
                    <!-- End: page-left -->
                    <!-- Start: page-right -->
                    ...
                    <div class="dashboard-pane">
                        ...
                        <div class="dashboard-pane-frame">
                            <!-- Start: dashboard-pane-subframe -->
                            <div class="dashboard-pane-subframe duration">
                                <div><span>Machine ID</span></div>
                                <div class="text-truncate"><span>--</span></div>
                            </div>
                            <!-- End: dashboard-pane-subframe -->
                            ...
                            <!-- Start: dashboard-pane-subframe -->
                            <div class="dashboard-pane-subframe duration">
                                <div><span>Job Duration</span></div>
                                <div class="text-truncate"><span>-- : -- : --</span></div>
                            </div>
                            <!-- End: dashboard-pane-subframe -->
                            <!-- Start: dashboard-pane-subframe -->
                            <div class="dashboard-pane-subframe duration">
                                <div><span>Downtime</span></div>
                                <div class="text-truncate"><span>-- : -- : --</span></div>
                            </div>
                            <!-- End: dashboard-pane-subframe -->
                        </div>
            ...
            <div id="overview-tab" class="tab-pane fade" role="tabpanel">
                <div class="page-subheader">
                    <div>
                        <div class="last-update">
                            <label style="margin-bottom: 0px;">Last update: 0000-00-00 00:00:00</label>
                        </div>
                        <span class="headerspan">
                            <span id="pgeOverviewtitle" class="pl-3" style="background-color: rgba(196,204,204,0);">Overview</span>
                        </span>
                        <!-- <div class="dash-paging"><button class="btn btn-sm shadow-none dash-page-left" type="button"><i class="fa fa-caret-left" style="color: #565959;"></i></button><label>Page 1 of 1</label><button class="btn btn-sm shadow-none dash-page-right" type="button"><i class="fa fa-caret-right" style="color: #565959;"></i></button></div> -->
                    </div>
                </div>
                <div id="overview-container" style="position: fixed; height: calc(100% - 78px);">
                    <!-- Start: overview-pane -->
                    <div class="overview-pane">
                        <div><label class="text-truncate">ID:</label><span>1</span></div>
                        <div>
                            <label class="text-truncate text-center overview-body-lbl">OFFLINE</label>
                        </div>
                    </div>
                    <!-- End: overview-pane -->
                    <!-- Start: overview-pane -->
                    ...
                    <div>
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-9 col-lg-9 col-xl-9">
                                <div class="float-end header-btn-grp w-100 h-100">
            ...
            <div id="unproductive-tab" class="tab-pane fade" role="tabpanel">
                <!-- Start: header -->
                <div class="page-subheader-tbl">
                    <div>
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3"><label id="pgeUnprodtitle" class="col-form-label px-3 w-100">Unproductive</label></div>
                            <div class="col-12 col-sm-12 col-md-9 col-lg-9 col-xl-9">
                                <div class="float-end header-btn-grp w-100 h-100"><button class="btn btn-dark btn-sm table-header-btn filter-btn" id="unproductive-filter" type="button"><i class="fa fa-filter"></i>&nbsp;<span>Filter</span></button><button class="btn btn-dark btn-sm table-header-btn view-btn" type="button"><i class="fas fa-calendar-check"></i><span>&nbsp;View</span></button>
                                    <!-- Start: To -->
                                    <div class="table-header-btn date-container date-realign-2">
                                        <div class="input-group input-group-sm">
                                            <div class="input-group-prepend">
                                                <span class="bg-dark border-dark input-group-text" style="color: rgb(255,255,255);"><i class="fa fa-calendar"></i>&nbsp;To</span>
                                            </div>
                                            <input class="border-dark form-control dateTo" type="text" style="background-color: transparent;" readonly="" placeholder="-- / -- / --">
                                        </div>
                                    </div>
                                    ...
                                    <div class="table-header-btn date-container date-realign-1">
                                        <div class="input-group input-group-sm">
                                            <div class="input-group-prepend">
                                                <span class="bg-dark border-dark input-group-text" style="color: rgb(255,255,255);"><i class="fa fa-calendar"></i>&nbsp;Fr</span>
                                            </div>
                                            <input class="border-dark form-control dateFr" type="text" style="background-color: transparent;" readonly="" placeholder="-- / -- / --">
                                        </div>
                                    </div>
                                    <!-- End: From --><button class="btn btn-dark active btn-sm table-header-btn today-btn" type="button"><i class="fas fa-cloud-sun kulayng-araw"></i><span>&nbsp;Today</span></button><button class="btn btn-dark btn-sm table-header-btn" id="unprod-export-btn"
                                        type="button"><i class="fa fa-download text-success"></i><label class="m-0">&nbsp;<span class="exportlbl">Export</span></label></button></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="inner-content">
                            ...
                            <div class="inner-footer px-3 pb-3">
                                ...
                                <div class="row no-gutters">
                                    <div class="col"><button class="btn btn-dark clearlbl" id="unprodClr" type="button"><i class="fas fa-eraser"></i><label class="mb-0">&nbsp;<span>Clear</span></label></button><button class="btn btn-dark float-end" id="unprodSave" type="button"><i class="fas fa-save"></i>&nbsp;<span>Save</span></button></div>
                                </div>
                            </div>
                            <!-- End: header -->
                        </div>
                ...
                <div class="inner-sidepanel sidepanel">
                    <div class="inner-content">
                        ...
                        <div class="inner-footer px-3 pb-3">
                            <hr style="margin-top: 5px; margin-bottom: 5px;">
                            <div class="row no-gutters">
                                <div class="col"><button class="btn btn-dark clearlbl" id="clr-sidepanel-btn" type="button"><i class="fas fa-eraser"></i><label class="mb-0">&nbsp;<span>Clear</span></label></button><button class="btn btn-dark float-end" id="del-sidepanel-btn" type="button"><i class="fas fa-trash-alt"></i></button>
                                    <button
                                        class="btn btn-dark float-end mr-1" id="upd-sidepanel-btn" type="button" data-bs-toggle="tooltip" title="Ctrl + e"><i class="fas fa-save"></i><label class="mb-0">&nbsp;Update</label></button><button class="btn btn-dark float-end mr-1" id="add-sidepanel-btn" type="button" data-bs-toggle="tooltip" title="Ctrl + s"><i class="fas fa-plus"></i><label class="mb-0">&nbsp;Add</label></button></div>
                            </div>
                        </div>
                        <!-- End: header -->
                    </div>
                ...
                <div class="config-content">
                    <div>
                        <ul class="nav nav-tabs text-dark minitabs"><!-- nav-fill removed -->
                            <li class="nav-item"><a class="nav-link active" role="tab" data-bs-toggle="tab" id="viewClusterBtn" href="#viewClusterTab">View Clusters</a></li>
                            <li class="nav-item"><a class="nav-link" role="tab" data-bs-toggle="tab" id="viewDevicesBtn" href="#viewDevicesTab">View Devices</a></li>
                            <li class="nav-item"><a class="nav-link" role="tab" data-bs-toggle="tab" id="mngDevicesBtn" href="#mngDevicesTab" hidden="true">Manage Devices</a></li>
                        </ul>
                                                    ...
                                                    <div class="cardio-header">
                                                        ...
                                                        <div class="cardio-title">
                                                            <div class="row no-gutters">
                                                                ...
                                                                <div class="col text-right"><button class="btn btn-outline-primary btn-sm border rounded editCluster-btn" type="button" style="padding: 0px;padding-right: 0;margin-right: -5px;"><i class="fa fa-edit fa-sm" style="padding: 5px;" data-bs-toggle="tooltip" data-placement="left" title="Edit Information"></i></button></div>
                                                            </div>
                                                        </div>
                                                        <!-- End: card-title -->
                                                        <!-- Start: card-name -->
                                        ...
                                        <div class="config-main-pane">
                                            ...
                                            <div class="config-tab-body" style="background-color: #2f2f2f1a;">
                                                <div class="row no-gutters align-items-center">
                                                    ...
                                                    <div class="col mb-2">
                                                        <button class="btn btn-light float-end" id="deleteDeviceBtn" type="button"><i class="fa fa-trash"></i></button>
                                                    </div>
                                                </div>
                                                    <!-- <button class="btn btn-light btn-lg float-end deleteDraggable" id="deleteDeviceBtn" type="button"><i class="fa fa-trash"></i></button> -->
                                                <!-- </div>     -->
                                                <!-- </div> -->
                                                <!-- Start: table -->
                                                <div>
                                            ...
                                            <div class="config-tab-body" style="background-color: transparent;">
                                                ...
                                                <div class="row no-gutters">
                                                    <div class="col text-left">
                                                        ...
                                                        <!-- <button class="btn btn-light btn-sm float-end deleteDraggable" id="deleteDeviceBtn" type="button"><i class="fa fa-trash"></i></button> -->
                                                    </div>
                                                </div>
                                                <div class="row no-gutters">
                                                    <div class="col">
                    ...
                    <div class="row" style="margin-right: 0;margin-left: 0;">
                        <div id="sideBtnContainer" class="active">
                            <div class="d-flex flex-column flex-grow-0 flex-shrink-0 justify-content-center content">
                                <button class="btn btn-primary system-route active" type="button" role="tab" data-bs-toggle="tab" data-bs-target="#dnt-config-page">
                                    <span>Date &amp; Time Settings</span>
                                    <span><i class="fa fa-caret-right"></i></span>
                                </button>
                                <button class="btn btn-primary system-route" type="button" role="tab" data-bs-toggle="tab" data-bs-target="#net-config-page">
                                    <span>Network Configuration</span>
                                    <span><i class="fa fa-caret-right"></i></span>
                                </button>
                                <button class="btn btn-primary system-route" type="button" role="tab" data-bs-toggle="tab" data-bs-target="#usr-config-page">
                                    <span>Users Management</span>
                                    <span><i class="fa fa-caret-right"></i></span>
                                </button>
                                <button class="btn btn-primary system-route" type="button" role="tab" data-bs-toggle="tab" data-bs-target="#csr-config-page">
                                    <span>Cause Registration</span>
                                    <span><i class="fa fa-caret-right"></i></span>
                                </button>
                                <button class="btn btn-primary system-route" type="button" role="tab" data-bs-toggle="tab" data-bs-target="#ind-config-page" disabled hidden>
                                    <span>Smart Counter Registration</span>
                                    <span><i class="fa fa-caret-right"></i></span>
                                </button>
                                <button class="btn btn-primary system-route" type="button" role="tab" data-bs-toggle="tab" data-bs-target="#dbm-config-page">
        ...
        <div class="modal fade" role="dialog" tabindex="-1" id="filterModal" data-backdrop="static">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-dark">
                        <h5 class="modal-title text-light"><i class="fa fa-filter"></i>&nbsp;<span>Filter Options</span></h5><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div>
                    <div class="modal-body">
                        ...
                        <div class="summary-checkbox">
                            <hr>
                            <div class="row no-gutters mb-2">
                                <div class="col-10"><label class="col-form-label pl-3 items">Show Scheduled End</label></div>
                                <div class="col align-self-center">
        ...
        <div class="modal fade" role="dialog" tabindex="-1" id="logoutModal">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-dark">
                        <h5 class="modal-title text-light"><i class="fa fa-sign-out text-danger"></i>&nbsp;<label class="logoutlbl">Logout</label></h5><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></div>
                    <div class="modal-body">
                        <p class="text-start mb-1 logoutPrompt">Are you sure you want to Logout?</p>
                    </div>
                    <div class="modal-footer">
                       <button class="btn btn-light cancelbl" type="button" data-bs-dismiss="modal">Cancel</button><button id="logoutYes" class="btn btn-dark proceedlbl" type="button" data-bs-dismiss="modal">Proceed</button>
                    </div>
                </div>
            </div>
        </div>
