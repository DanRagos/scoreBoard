function initRecordSummary(prendvisible = true, scendvisible = false) {
	if($.isEmptyObject(flags.summary.table)) {
		flags.summary.table = $('#summaryTbl').DataTable({
			...
			"columnDefs": [
		        ...
		        { "width": "102px", "targets": 15 },
		        { "type": 'natural', "targets": [0, 1, 4, 5, 14] },
	            ...
	            { targets: 10, orderData: [10, 2, 1] },
	            { targets: 11, orderData: [11, 2, 1] },
				{ targets: 12, orderData: [12, 2, 1] },
				{ targets: 13, orderData: [13, 2, 1] },
				{ targets: 14, orderData: [14, 2, 1] },
				{ targets: 15, orderData: [15, 2, 1] },
				{ targets: 16, orderData: [16, 2, 1] },
